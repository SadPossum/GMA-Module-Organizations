...
public static class OrganizationApplicationErrors
{
    ...
    public static readonly Error JoinAdmissionUnavailable = new("Organizations.JoinAdmissionUnavailable", "Organization join admission is temporarily unavailable.");
