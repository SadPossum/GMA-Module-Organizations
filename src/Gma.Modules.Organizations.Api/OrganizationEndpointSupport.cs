...
internal static class OrganizationEndpointSupport
{
    public static readonly ApiErrorStatusCodeMap ErrorStatusCodes = ApiErrorStatusCodeMap.Create(
        ...
        new(OrganizationApplicationErrors.CreationRejected.Code, StatusCodes.Status403Forbidden),
        new(OrganizationApplicationErrors.CreationAdmissionUnavailable.Code, StatusCodes.Status503ServiceUnavailable),
        ...
        new(OrganizationApplicationErrors.RecipientVerificationUnavailable.Code, StatusCodes.Status503ServiceUnavailable),
